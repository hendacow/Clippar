...
import { Scissors, RotateCcw, X, Check, Pause } from 'lucide-react-native';
...
export function PreviewPlayer({
  ...
  // With trim enabled the panel is DOCKED — no scissors button to press first.
  // `isTrimming` therefore tracks "the trim UI is up", which is always true in
  // that mode, and still gates auto-advance so a clip loops while you edit it.
